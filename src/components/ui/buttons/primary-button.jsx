...
const buttonVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap text-center capitalize font-medium rounded-xl transition-colors outline-0 disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                default: "liquid-button liquid-button--primary bg-primary text-white",
                asLink: "text-xs font-medium text-primary hover:underline",
...
const PrimaryButton = React.forwardRef(({ className, variant, to, size, isLoading, children, ...props }, ref) => {
    return to ? (
