...
import { getDataControllerService } from "@/services/publicView/DataServices";
...
export default function DataControllerPage(props) {
    ...
    const [dataFilter, setDataFilter] = useState({
        ...
        page: 1,
        limit: 10,
        extra_filter: {"formStatusIn": [4,6]},
    });
    const tableColumn = [
        { name: "Name", isAppendClass: "rounded-tl-[10px]" },
        { name: "License Date", isAppendClass: "" },
        { name: "DPA Number", isAppendClass: "" },
        { name: "Email", isAppendClass: "" },
        { name: "Phone", isAppendClass: "" },
        { name: "State", isAppendClass: "" },
        { name: "Status", isAppendClass: "rounded-tr-[10px]" },
    ];
    ...
    const getTableData = () => {
        setIsLoading(true);
        dispatch(getDataControllerService(dataFilter))
            .then((res) => {
