...
import { getDataComplaintService } from "@/services/user/DataComplaintServices";
...
export default function ComplaintHandlePage(props) {
    ...
    const tableColumn = [
        ...
        { name: "Licence", isAppendClass: "" },
        { name: "Name", isAppendClass: "" },
        { name: "Email", isAppendClass: "" },
        { name: "Contact Number", isAppendClass: "" },
        { name: "Attorney", isAppendClass: "rounded-tr-[10px]" },
    ];
    ...
    const getTableData = () => {
        setIsLoading(true);
        dispatch(getDataComplaintService(dataFilter))
            .then((res) => {
